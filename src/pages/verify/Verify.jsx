...
const Verify = (props) => {
  ...
  const verifySms = () => {
    ...
    if( sms != '' ){
      ...
      telefone = telefone.replace(" ", "", telefone);
      telefone = telefone.replace("-", "", telefone);
      axiosConfig.post("/Clinica/ValidaTelefone?telefone=55"+telefone+"&pin="+sms)
      .then((response) => {
  ...
  return (
    <>
      <div className="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
            <a onClick={() => navigate('/cadastrar')} className="text-dark bg-white shadow rounded-circle icon">
