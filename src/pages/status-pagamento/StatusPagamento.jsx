                ...
                <form action="" className="">
                  <div className="row">
                    <div className="mb-4 col-md-4">
                      ...
                      <p className="font-weight-400 mb-2">carlos@carlos.com</p>
                    </div>
                    <div className="mb-4 col-md-4">
                      <label for="" className="extratoPG">
                        Contato
                    ...
                    <div className=" mb-4 col-md-4">
                      ...
                      <p className="font-weight-400 mb-2">Rua Capote Valente</p>
                    </div>
                    <div className=" mb-4 col-md-4">
                      <label for="" className="extratoPG">
                        Número
                ...
                <form action="" className="">
                  <div className="row">
                    ...
                    <div className=" mb-4 col-md-4">
                      ...
                      <p className="font-weight-400 mb-2">Cartão de crédito</p>
                    </div>
                    <div className=" mb-4 col-md-4">
                      <label for="" className="extratoPG">
                        Número do cartão
