...
const Selfie = () => {
  return (
    ...
    <div className="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
            <a href="/responsavel" className="text-dark bg-white shadow rounded-circle icon">
      ...
      <div className="footer fixed-bottom d-grid gap-3 m-3">
        <a href="#" class="btn btn-info btn-lg w-100 rounded-4">
          Buscar na galeria
        </a>
        <a href="/finalizar" class="btn btn-outline-info btn-lg w-100">
          Continuar
        </a>
      </div>
    </>
