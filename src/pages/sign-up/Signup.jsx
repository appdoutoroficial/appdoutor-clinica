         ...
         <form>
            <div className="mb-3">
               ...
               <div className="input-group border bg-white rounded-3 py-1" id="exampleFormControlEmail">
                  ...
                  <input type="email" className="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Digite o E-mail da sua clínica" aria-label="Type your email or phone" aria-describedby="mail" value="" />
               </div>
            </div>
            <div className="mb-3">
            ...
            <div>
               <a href="/verify" className="btn btn-info btn-lg w-100 rounded-4 mb-3">Criar Conta</a>
